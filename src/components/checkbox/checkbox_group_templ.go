...
func CheckboxGroup(props ...GroupProps) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		var templ_7745c5c3_Var2 = []any{utils.TwMerge("flex flex-wrap gap-2", p.Class)}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `src/components/checkbox/checkbox_group.templ`, Line: 1, Col: 0}
		}
		...
		for _, option := range p.Options {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `src/components/checkbox/checkbox_group.templ`, Line: 44, Col: 52}
			}
